  ...
  if (sidebar) {
    return (
      <div className="absolute inset-0 z-[2000] flex items-stretch justify-start bg-black/70 md:bg-transparent md:pointer-events-none">
        <div
          className="jd-scroll pointer-events-auto flex w-full h-full flex-col overflow-hidden bg-gerayo-panel border border-gerayo-border md:m-4 md:max-h-[calc(100%-2rem)] md:h-[calc(100%-2rem)] md:w-[420px] md:rounded-2xl xl:mb-0 xl:max-h-[calc(100%-279px)] xl:h-[calc(100%-279px)]"
        >
